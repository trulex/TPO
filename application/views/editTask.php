<!--avtor:Lovrenc-->
<?php /*echo form_open('editTask/taskModifier');*/ ?>

<div id="content">
    <div id="left">
	<div id="add">
	<p>Edit Task </p>
	    <form name="editTask" method="post" action="editTask/taskModifier">
			...
			<input type="checkbox" name="accepted" checked="<?php echo $TAccepted?>" /><br>
			<label>Completed</label>
			<input type="checkbox" name="completed" checked="<?php echo $TCompleted?>" /><br>
