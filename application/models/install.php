...
// 	Create all tables
	function initializeDatabase(){
		...
		$query = $this->db->query("CREATE TABLE IF NOT EXISTS tasks(id INT(10) AUTO_INCREMENT PRIMARY KEY UNIQUE KEY, name VARCHAR(50), StID INT(10), text VARCHAR(500) DEFAULT '', time_estimate DECIMAL(5,2) DEFAULT 0, UID INT(10), accepted TINYINT(1) DEFAULT 0, start_time DATETIME, end_time DATETIME, time_sum INT(11) DEFAULT 0,active TINYINT(1) DEFAULT 0, completed TINYINT(1) DEFAULT 0)"); 
		...
		$query = $this->db->query("CREATE TABLE IF NOT EXISTS work(id INT(5), date DATE, TID INT(10), time_sum INT(11) DEFAULT 0, remaining INT(11) DEFAULT 0, PID INT(10)) ");
	}
